...
//send a msg in the chat session
...
export const sendMessage = async (req: Request, res: Response) => {
  try {
    ...
    // Safely handle the possibility of an undefined response
    const cleanJsonString = (analysis_res ?? "")
      .replace(/```json\n|\n```/g, "")
      .trim();
...
export const getAllChatSessions = async (req: Request, res: Response) => {
  try {
    ...
    // Find all chat sessions for the given userId and sort them by the most recent
