...
import { Gamepad2, Flower2, Wind, TreePine, Waves, Play } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
...
const games = [
  {
    ...
    description: "Follow gentle breathing rhythms to relax and refocus",
    icon: Wind,
    color: "text-blue-500",
  ...
  },
  {
    id: "garden",
    title: "Zen Garden",
    description: "Cultivate calm as you design your own peaceful garden space",
    icon: Flower2,
    color: "text-rose-500",
  ...
  },
  {
    ...
    description: "Wander mindfully through a soothing forest environment",
    icon: TreePine,
  ...
  },
  {
    id: "waves",
    title: "Ocean Waves",
    description: "Breathe with the rhythm of calming ocean tides",
    icon: Waves,
    color: "text-cyan-500",
